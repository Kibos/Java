...
class Functional {
	...
	static class FooEx42Adder implements Combiner<FooEx42> {

		@Override
		public FooEx42 combine(FooEx42 x, FooEx42 y) {
			return new FooEx42(x.getFoo() + y.getFoo());
		}
	...
	public static void testNewClass() {
		List<FooEx42> li = Arrays.asList(new FooEx42(1), new FooEx42(2));
		FooEx42 result = reduce(li, new FooEx42Adder());
		System.out.println(result);
	}

	public static void testFP() {
